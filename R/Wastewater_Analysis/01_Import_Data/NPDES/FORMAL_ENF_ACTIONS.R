...
echo_NPDES_FORMAL_ENFORCEMENT_ACTIONS_FORMATTED <-
  ...
  # mutate(SETTLEMENT_ENTERED_DATE = as.Date(SETTLEMENT_ENTERED_DATE, format = "%d-%b-%y")) %>% if the above date format doesn't work, use this one.
...
# Export ----
vroom_write(echo_NPDES_FORMAL_ENFORCEMENT_ACTIONS_FORMATTED,
